...
func TestAllUnsupportedOpcodes(t *testing.T) {
	supported := map[byte]bool{0: true, 4: true, 5: true, 6: true, 0x0a: true, 0x12: true, 0x13: true, 0x14: true, 0x15: true, 0x1f: true, 0x31: true, 0x36: true, 0x3c: true, 0x3d: true, 0x3e: true, 0x41: true, 0x42: true, 0x43: true, 0x44: true, 0x45: true, 0x96: true, 0x97: true, 0xff: true}
	for i := 0; i < 256; i++ {
		op := byte(i)
		if supported[op] {
			continue
